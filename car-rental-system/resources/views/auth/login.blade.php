    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-600">{{ __('common.remember_me') }}</span>
                        </label>
                    </div>
                ...
                {{-- Social Login --}}
                <div class="space-y-3">
                    <a href="{{ route('social.redirect', 'google') }}" class="flex items-center justify-center gap-3 w-full py-2.5 border border-gray-200
                    ...
                    <a href="{{ route('social.redirect', 'facebook') }}" class="flex items-center justify-center gap-3 w-full py-2.5 border border-gray-200
                                          rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
