                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select name="status"
                                ...
                                <option value="pending"   {{ $booking->status === 'pending'   ? 'selected' : '' }}>{{ __('common.pending') }}</option>
                                <option value="confirmed" {{ $booking->status === 'confirmed' ? 'selected' : '' }}>{{ __('common.confirmed') }}</option>
                                <option value="active"    {{ $booking->status === 'active'    ? 'selected' : '' }}>{{ __('bookings.active') }}</option>
                                <option value="completed" {{ $booking->status === 'completed' ? 'selected' : '' }}>{{ __('common.completed') }}</option>
                                <option value="cancelled" {{ $booking->status === 'cancelled' ? 'selected' : '' }}>{{ __('common.cancelled') }}</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <button type="submit"
                                class="w-full py-2.5 bg-indigo-600 text-white text-sm font-semibold
