            ...
            <div class="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex gap-1">
                        @php
                            $periodLabels = [
                                'daily' => app()->getLocale() === 'fa' ? 'روزانه' : (app()->getLocale() === 'ps' ? 'ورځني' : 'Daily'),
                                'weekly' => app()->getLocale() === 'fa' ? 'هفتگی' : (app()->getLocale() === 'ps' ? 'اونیز' : 'Weekly'),
                                'monthly' => app()->getLocale() === 'fa' ? 'ماهانه' : (app()->getLocale() === 'ps' ? 'میاشتني' : 'Monthly'),
                            ];
                        @endphp
