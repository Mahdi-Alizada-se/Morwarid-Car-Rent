...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {{-- Change Password Card (instant, no approval needed) --}}
    <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6"
         x-data="{ showPw: false, showNewPw: false, showConfirmPw: false }">
        <h2 class="font-bold text-gray-900 dark:text-gray-100 mb-1">{{ __('profile.change_password') }}</h2>
        <p class="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2 mb-5 mt-3">
            ℹ️ {{ __('profile.password_change_note') }}
        </p>
        ...
        <form method="POST" action="{{ route('customer.profile.password') }}" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input :type="showPw ? 'text' : 'password'" name="current_password"
            ...
            <div>
                ...
                <div class="relative">
                    <input :type="showNewPw ? 'text' : 'password'" name="password"
                           class="w-full text-sm border border-gray-200 dark:border-gray-700 dark:bg-gray-800
                                  dark:text-gray-100 rounded-xl px-4 py-2.5 pr-12
                                  focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <button type="submit" class="w-full py-2.5 bg-gray-800 dark:bg-gray-700 text-white text-sm font-semibold
                                   rounded-xl hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors">
