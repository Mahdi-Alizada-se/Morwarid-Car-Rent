                        ...
                        <template x-if="!currentImage">
                            <div class="w-full h-full flex items-center justify-center">
                                <svg class="w-16 h-16 text-gray-300" fill="none" stroke="currentColor" stroke-width="1.5"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9
                        ...
                        @else
                            ...
                            <div class="space-y-3 mb-4">
                                <div>
                                    ...
                                    <input type="text" id="v-pickup-date" placeholder="Select date" readonly
                                ...
                                <div>
                                    ...
                                    <input type="text" id="v-return-date" placeholder="Select date" readonly
                                        class="w-full text-sm border border-gray-200 rounded-lg
                                                                                                                                      px-3 py-2.5 focus:outline-none focus:ring-2
                                                                                                                                      focus:ring-indigo-500 bg-white cursor-pointer">
                                </div>
                            ...
                            <div x-show="pricing && pricing.available && selectedFrom && selectedTo" x-cloak class="mb-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div x-show="paymentMethod === 'cash'" x-cloak
                                        class="p-3 bg-orange-50 border border-orange-200
                                                                                                                                    rounded-xl text-xs text-orange-700">
                                        ⚠️ Your payment must be completed within <strong>5 hours</strong>
                                        or the system will automatically cancel your booking.
                                    </div>
                                ...
                                <div x-show="paymentMethod === 'bank_transfer'" x-cloak
                                    class="mt-3 p-4 bg-blue-50 border border-blue-200
                                                                                                                                rounded-xl space-y-3">
                                    <p class="text-sm font-semibold text-blue-800">Bank Transfer Details</p>
                                    <div
                                        class="bg-white rounded-lg p-3 text-xs space-y-1.5
                                    ...
                                    <div>
                                        ...
                                        <input type="text" x-model="bankSenderName" placeholder="Name used for the transfer"
                                            class="w-full text-sm border border-gray-300 rounded-lg
                                                                                                                                          px-3 py-2 focus:outline-none focus:ring-2
                                                                                                                                          focus:ring-blue-500">
                                    </div>
                                ...
                                <div x-show="paymentMethod === 'mastercard'" x-cloak
                                    class="mt-3 p-4 bg-purple-50 border border-purple-200
                                                                                                                                rounded-xl space-y-3">
                                    ...
                                    <p class="text-xs text-purple-600">
                                        ...
                                        You will be charged after confirming your booking.
                                    </p>
                                    <div>
                                        <label class="block text-xs font-semibold text-gray-600 mb-1">
                                            Cardholder Name <span class="text-red-500">*</span>
                                        </label>
                                        <input type="text" x-model="cardName" placeholder="Name on card"
                                            class="w-full text-sm border border-gray-300 rounded-lg
                                                                                                                                          px-3 py-2 focus:outline-none focus:ring-2
...
@push('scripts')
    ...
    <script>
        // ── Booked dates — convert to flatpickr format ────────────────────────────────
        const rawBookedDates = @json($bookedDates);

        // Build disabled dates array for flatpickr
        // If dates are strings like "2026-06-04", convert to Date objects
        ...
        document.getElementById('booking-form').addEventListener('submit', async function (e) {
            ...
            // For cash and bank transfer — submit form normally
            ...
            try {
                // Step 1 — Create booking via JSON
                ...
                if (!bookingData.booking_id) {
                    throw new Error(bookingData.message || bookingData.error || 'Booking failed. Please try again.');
                }
                ...
                submitBtn.textContent = 'Confirm Booking — Pay by Card';
            }
        });
    </script>
@endpush